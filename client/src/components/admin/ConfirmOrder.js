...
import { getConfirmOrder } from "../../actions/orderActions";
...
class ConfirmOrder extends Component {
  ...
  componentDidMount() {
    this.props.getConfirmOrder();
  }
  componentWillReceiveProps(nextProps) {
    if (nextProps.order) {
      this.setState({
        ...this.state,
        confirmOrders: nextProps.order.confirm_order
      });
    }
  }

  render() {
    let reverse = this.state.confirmOrders.reverse();
